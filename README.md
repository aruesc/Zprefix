...
### v1.0.0.13 (2024-12-XX) - 最新版本 ✨
- 🎯 **显示名支持**: `/title info` 和 `/title set` 指令支持称号显示名
- 📊 **统计系统大幅优化**: 从16个扩展到35个统计参数 (+187%)
- ⛏️ **矿物挖掘统计**: 新增10个矿物挖掘数量统计参数
- 👹 **生物击杀统计**: 新增9个生物击杀数量统计参数 (Boss、怪物、动物)
- 🏠 **生活活动统计**: 新增4个生活活动数量统计参数
- 🎯 **智能Tab补全**: 支持显示名补全、权限过滤和智能匹配
- 🔄 **GUI优化**: 简化lore内容，移除重复信息，职责分离
- 🏆 **称号体系完善**: 26个预设称号，涵盖6大系列完整进阶路线
- ✨ **用户体验革命性提升**: 所见即所得的操作体验，零学习成本
